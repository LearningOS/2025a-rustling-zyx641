...
unsafe fn modify_by_address(address: usize) {
    // SAFETY: The contract of this function requires that the address
    // contains a mutable reference to a valid `u32` value. We assume
    // the caller has ensured this contract is met.
    unsafe {
